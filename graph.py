...
def animation_function(i):
    ...
    #Iterating over the list of CPU values and appending each value (converted to float) to the previously created list - x adding an if statemtnt to exclude any blank lines in the file
